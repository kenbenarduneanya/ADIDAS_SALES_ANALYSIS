...
![Adidas_2022_logo svg](https://github.com/user-attachments/assets/f5569973-713b-45df-8c26-88b77ec1151f)
...
This Data Analysis project aims to provide insights into the sales performance of Adidas in the United States Domestic Market from 2020-2021. By analyzing various data, we look to identify trends, make data driven recomendations, and gain a deeper understanding of the companies performance.
##### Data Sources
...
##### Tools Utilized
* MS Excel - Data Cleaning, Data Analysis
...
* The Geographical areas with the highest Performance  
* Geographical Areas With High Growth Potential are;
  * SOUTH CAROLINA (AVG SALES = $203,372.4792)
* Geographical Areas with the Lowest Growth Potential
  * RHODE ISLAND (AVG SALES = $39,105.5833)
* Insights Into Product Performance, Aiding in Inventory and Marketing Decisions;
...
* Increase marketing efforts in states with high growth potential.
* Ensure adequate marketing and inventory priority should be given to the best performing products to maintain market dominance and subsequently other categories to ensure growth across the categories.
* Proper consideration of strategies to improve margins and profitabilities given and accurately executed.
...
### Exploratory Data Analysis For Technical Review
